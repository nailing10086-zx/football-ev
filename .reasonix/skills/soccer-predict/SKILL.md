...
2. 使用 `mcp__firecrawl-mcp__firecrawl_scrape` 获取页面内容（formats: ["markdown"]，waitFor: 3000）
3. 从返回的 markdown 中提取亚盘、大小球、欧赔、基本面、阵容、盘路等数据。
4. 详见 [references/data-collection.md](references/data-collection.md)
